...
func NewCommonService(name string, c client.Client) CommonService {
	...
	if len(name) == 0 {
		name = "nezha.chat.common.srv.service"
	}
...
func (c *commonService) GetList(ctx context.Context, in *GetListReq, opts ...client.CallOption) (*GetListResp, error) {
	req := c.c.NewRequest(c.name, "Common.GetList", in)
	out := new(GetListResp)
...
func (h *commonHandler) GetList(ctx context.Context, in *GetListReq, out *GetListResp) error {
	return h.CommonHandler.GetList(ctx, in, out)
}
